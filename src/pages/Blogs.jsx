      ...
      <div className="container mx-auto my-12 p-4">
        ...
        <div className="mb-8 text-center">
          <input
            ...
            className="w-full sm:w-1/3 px-4 py-2 border rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300 transform hover:scale-105"
            value={searchTerm}
